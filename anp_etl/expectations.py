...
def expectation_to_check_categorical_cols_values(suite):
    ...
    cols_and_checks = {
        ...
        "Estado - Sigla": [
            "SC", "RO", "PI", "AM", "RR", "GO", "TO", "MT", "SP", 
            "ES", "PB", "RS", "MS", "AL", "MG", "PA", "BA", "SE", 
            "PE", "CE", "RN", "RJ", "MA", "AC", "DF", "PR", "AP"
            ],
    }
...
def expectation_to_check_columns_order(suite):
    ...
    expectation_configuration = ExpectationConfiguration(
        ...
        kwargs={
            "column_list": ["Regiao - Sigla", "Estado - Sigla", "Municipio", "Revenda", "CNPJ da Revenda", 
